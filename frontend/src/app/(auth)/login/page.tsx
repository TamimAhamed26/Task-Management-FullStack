...
export default function LoginPage() {
  ...
  // This function handles the traditional email/password login
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/test-collaborators'); 
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-base-200 via-base-300 to-base-100 flex items-center justify-center px-4 py-8">
      ...
      <div className="relative w-full max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 bg-base-100 rounded-3xl shadow-2xl overflow-hidden backdrop-blur-sm bg-opacity-95">
          ...
          <div className="relative bg-gradient-to-br from-primary to-secondary p-12 flex-col justify-center items-center text-primary-content overflow-hidden hidden lg:flex">
            ...
            <div className="w-full max-w-md mx-auto">
              ...
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/forgot-password" className="link link-primary text-sm font-medium hover:underline">
                    Forgot password?
                  </Link>
                </div>
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="btn btn-primary w-full py-3 text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-300"
                >
                ...
                <div className="grid grid-cols-1 gap-4">
                  <button 
                    type="button" 
                    className="btn btn-outline btn-neutral hover:btn-neutral transition-all duration-300"
                ...
                <div className="text-center pt-6">
                  <p className="text-base-content/60">
                    ...
                    <Link href="/signup" className="link link-primary font-semibold hover:underline">
                      Sign up 
                    </Link>
                  </p>
                </div>
